...
@media (forced-colors: active) {
  ...
  <body>
    <app-root ng-version="21.2.18" ng-server-context="ssg"><router-outlet></router-outlet><app-login _nghost-ng-c1643857190><div _ngcontent-ng-c1643857190 class="min-h-screen bg-black flex flex-col justify-center py-12 sm:px-6 lg:px-8 font-sans animate-fade-in"><div _ngcontent-ng-c1643857190 class="sm:mx-auto sm:w-full sm:max-w-md text-center"><div _ngcontent-ng-c1643857190 class="inline-flex w-12 h-12 bg-emerald-500 rounded-xl items-center justify-center shadow-lg shadow-emerald-500/20 mb-4"><mat-icon _ngcontent-ng-c1643857190 role="img" class="mat-icon notranslate !w-6 !h-6 !text-black flex items-center justify-center font-bold material-icons mat-ligature-font mat-icon-no-color" aria-hidden="true" data-mat-icon-type="font">notifications_active</mat-icon></div><h2 _ngcontent-ng-c1643857190 class="text-3xl font-black text-white tracking-tight"> IPO Alert Pro </h2><p _ngcontent-ng-c1643857190 class="mt-2 text-sm text-zinc-400 font-medium"> Enterprise subscription &amp; alert intelligence </p></div><div _ngcontent-ng-c1643857190 class="mt-8 sm:mx-auto sm:w-full sm:max-w-md"><div _ngcontent-ng-c1643857190 class="bg-zinc-900 py-8 px-4 shadow-2xl border border-zinc-800/80 sm:rounded-2xl sm:px-10"><div _ngcontent-ng-c1643857190 class="flex border-b border-zinc-800 mb-6"><button _ngcontent-ng-c1643857190 class="flex-1 pb-3 text-sm font-bold text-center border-b-2 transition-colors cursor-pointer border-emerald-500 text-emerald-400"> Sign In </button><button _ngcontent-ng-c1643857190 class="flex-1 pb-3 text-sm font-bold text-center border-b-2 transition-colors cursor-pointer border-transparent text-zinc-500"> Register </button></div><!----><form _ngcontent-ng-c1643857190 novalidate class="space-y-4 ng-untouched ng-pristine ng-invalid"><div _ngcontent-ng-c1643857190><span _ngcontent-ng-c1643857190 class="block text-xs font-bold text-zinc-400 uppercase tracking-wider mb-2">WhatsApp Number</span><mat-form-field _ngcontent-ng-c1643857190 appearance="outline" class="mat-mdc-form-field w-full custom-login-field mat-mdc-form-field-type-mat-input mat-mdc-form-field-has-icon-prefix mat-form-field-appearance-outline mat-primary ng-untouched ng-pristine ng-invalid"><!----><div class="mat-mdc-text-field-wrapper mdc-text-field mdc-text-field--outlined mdc-text-field--no-label"><!----><div class="mat-mdc-form-field-flex"><div matformfieldnotchedoutline class="mdc-notched-outline mdc-notched-outline--no-label"><div class="mat-mdc-notch-piece mdc-notched-outline__leading"></div><div class="mat-mdc-notch-piece mdc-notched-outline__notch"><!----></div><div class="mat-mdc-notch-piece mdc-notched-outline__trailing"></div></div><!----><div class="mat-mdc-form-field-icon-prefix"><mat-icon _ngcontent-ng-c1643857190 role="img" matprefix class="mat-icon notranslate text-zinc-500 mr-2 material-icons mat-ligature-font mat-icon-no-color" aria-hidden="true" data-mat-icon-type="font">phone</mat-icon></div><!----><!----><div class="mat-mdc-form-field-infix"><!----><!----><!----><input _ngcontent-ng-c1643857190 matinput type="tel" formcontrolname="whatsapp" placeholder="Enter WhatsApp number" class="mat-mdc-input-element ng-untouched ng-pristine ng-invalid mat-input-server mat-mdc-form-field-input-control mdc-text-field__input" value id="mat-input-0" required aria-required="true"></div><!----><!----></div><!----></div><div aria-atomic="true" aria-live="polite" class="mat-mdc-form-field-subscript-wrapper mat-mdc-form-field-bottom-align"><!----><div class="mat-mdc-form-field-hint-wrapper"><!----><div class="mat-mdc-form-field-hint-spacer"></div></div><!----></div></mat-form-field></div><div _ngcontent-ng-c1643857190><span _ngcontent-ng-c1643857190 class="block text-xs font-bold text-zinc-400 uppercase tracking-wider mb-2">Password</span><mat-form-field _ngcontent-ng-c1643857190 appearance="outline" class="mat-mdc-form-field w-full custom-login-field mat-mdc-form-field-type-mat-input mat-mdc-form-field-has-icon-prefix mat-mdc-form-field-has-icon-suffix mat-form-field-appearance-outline mat-primary ng-untouched ng-pristine ng-invalid"><!----><div class="mat-mdc-text-field-wrapper mdc-text-field mdc-text-field--outlined mdc-text-field--no-label"><!----><div class="mat-mdc-form-field-flex"><div matformfieldnotchedoutline class="mdc-notched-outline mdc-notched-outline--no-label"><div class="mat-mdc-notch-piece mdc-notched-outline__leading"></div><div class="mat-mdc-notch-piece mdc-notched-outline__notch"><!----></div><div class="mat-mdc-notch-piece mdc-notched-outline__trailing"></div></div><!----><div class="mat-mdc-form-field-icon-prefix"><mat-icon _ngcontent-ng-c1643857190 role="img" matprefix class="mat-icon notranslate text-zinc-500 mr-2 material-icons mat-ligature-font mat-icon-no-color" aria-hidden="true" data-mat-icon-type="font">lock</mat-icon></div><!----><!----><div class="mat-mdc-form-field-infix"><!----><!----><!----><input _ngcontent-ng-c1643857190 matinput formcontrolname="password" placeholder="Enter your password" class="mat-mdc-input-element ng-untouched ng-pristine ng-invalid mat-input-server mat-mdc-form-field-input-control mdc-text-field__input" type="password" value id="mat-input-1" required aria-required="true"></div><!----><div class="mat-mdc-form-field-icon-suffix"><button _ngcontent-ng-c1643857190 type="button" mat-icon-button matsuffix class="mdc-icon-button mat-mdc-icon-button mat-mdc-button-base !text-zinc-500 hover:!text-emerald-400 mat-unthemed _mat-animation-noopable" mat-ripple-loader-uninitialized mat-ripple-loader-class-name="mat-mdc-button-ripple" mat-ripple-loader-centered aria-label="Hide password" aria-pressed="false"><span class="mat-mdc-button-persistent-ripple mdc-icon-button__ripple"></span><mat-icon _ngcontent-ng-c1643857190 role="img" class="mat-icon notranslate material-icons mat-ligature-font mat-icon-no-color" aria-hidden="true" data-mat-icon-type="font">visibility</mat-icon><span class="mat-focus-indicator"></span><span class="mat-mdc-button-touch-target"></span></button></div><!----></div><!----></div><div aria-atomic="true" aria-live="polite" class="mat-mdc-form-field-subscript-wrapper mat-mdc-form-field-bottom-align"><!----><div class="mat-mdc-form-field-hint-wrapper"><!----><div class="mat-mdc-form-field-hint-spacer"></div></div><!----></div></mat-form-field></div><!----><button _ngcontent-ng-c1643857190 type="submit" class="w-full rounded-full py-4 bg-emerald-500 hover:bg-emerald-600 text-black font-black text-sm tracking-wide shadow-lg shadow-emerald-500/15 flex flex-row items-center justify-center gap-2 cursor-pointer transition-all duration-200 disabled:opacity-40 disabled:cursor-not-allowed select-none whitespace-nowrap" disabled><!----><span _ngcontent-ng-c1643857190>Sign In</span><!----></button></form><!----><!----></div></div></div></app-login><!----></app-root>
  <link rel="modulepreload" href="chunk-FBNFARPF.js"><script src="main-TXQFMMPW.js" type="module"></script>
